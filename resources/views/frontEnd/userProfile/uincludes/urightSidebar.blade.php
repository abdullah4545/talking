<aside class="sidebar static">
    <div class="widget">
            ...
            <div class="your-page">
                <figure>
                    <a title="" href="#"><img alt="" src="{{asset('public/frontEnd/images/')}}/resources/friend-avatar9.jpg"></a>
                </figure>
                <div class="page-meta">
                        ...
                        <span><i class="ti-heart"></i>884</span>
                          ...
                          <div class="users-thumb-list">
                              <a data-toggle="tooltip" title="" href="#" data-original-title="Anderw">
                                <img alt="" src="{{asset('public/frontEnd/images/')}}/resources/userlist-1.jpg">
                            </a>
                            <a data-toggle="tooltip" title="" href="#" data-original-title="frank">
                                <img alt="" src="{{asset('public/frontEnd/images/')}}/resources/userlist-2.jpg">
                            </a>
                            <a data-toggle="tooltip" title="" href="#" data-original-title="Sara">
                                <img alt="" src="{{asset('public/frontEnd/images/')}}/resources/userlist-3.jpg">
                            </a>
                            <a data-toggle="tooltip" title="" href="#" data-original-title="Amy">
                                <img alt="" src="{{asset('public/frontEnd/images/')}}/resources/userlist-4.jpg">
                            </a>
                            <a data-toggle="tooltip" title="" href="#" data-original-title="Ema">
                                <img alt="" src="{{asset('public/frontEnd/images/')}}/resources/userlist-5.jpg">
                            </a>
                            <a data-toggle="tooltip" title="" href="#" data-original-title="Sophie">
                                <img alt="" src="{{asset('public/frontEnd/images/')}}/resources/userlist-6.jpg">
                            </a>
                            <a data-toggle="tooltip" title="" href="#" data-original-title="Maria">
                                <img alt="" src="{{asset('public/frontEnd/images/')}}/resources/userlist-7.jpg">
                            </a>
                          </div>
                      </div>
